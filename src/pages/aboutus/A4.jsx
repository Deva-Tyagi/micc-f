...
const ContactInfoSection = () => {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      info: "First Floor, SBI Bank, New Adarsh Nagar, Roorkee, Haridwar, Uttarakhand – 247667",
      delay: 0.4,
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          <iframe
            src="https://maps.google.com/maps?q=Mahi+Institute+Computer+Center+Adarsh+Nagar+Roorkee&t=&z=13&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="300"
