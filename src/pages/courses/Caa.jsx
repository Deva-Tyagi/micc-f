...
const CaaCourseDetail = () => {
  ...
  const faqs = [
    {
      question: "Do I need prior computer knowledge for this course?",
      answer:
        "No prior knowledge is required. This course starts from the basics and gradually builds up to advanced topics, making it perfect for beginners.",
    },
    {
      question: "Will I receive a certificate upon completion?",
      answer:
        "Yes, you will receive a Certification in Computer Applications (CCA) upon successful completion of all modules and assessments.",
    },
    {
      question: "What software will I learn?",
      answer:
        "You'll learn MS Office Suite (Word, Excel, PowerPoint), design tools (Corel Draw, Photoshop), programming languages (C, Python, HTML), and more.",
    },
    {
      question: "How long does the course take?",
      answer:
        "The complete course duration is 6 weeks with flexible learning schedules to accommodate working professionals and students.",
    },
  ];
  ...
  const modules = [
    {
      ...
      topics: [
        ...
        "MS Excel - Data analysis and formulas",
    ...
    },
    {
      ...
      duration: "1 week",
      topics: [
        "English typing (35+ WPM target)",
        "Hindi typing (25+ WPM target)",
    ...
    },
    {
      ...
      duration: "1 week",
      topics: [
        "Corel Draw - Vector graphics and layouts",
        "Adobe Photoshop - Image editing and enhancement",
    ...
    },
    {
      ...
      topics: [
        ...
        "Python - Modern programming concepts",
        "Computer Technology Program (CTP) basics",
      ],
    },
  ];
    ...
    <>
      ...
      <div className="relative h-[500px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80')",
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-8 z-10">
          ...
          >
            ...
            <p className="text-xl text-center max-w-3xl mx-auto mt-4 text-gray-200">
              Master essential computer skills from fundamentals to advanced
              applications
            </p>
            ...
            <div className="grid grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  This comprehensive certification program covers everything
                  from computer fundamentals to advanced applications including
                  MS Office, graphic design, web development, and programming.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Perfect for students, professionals, and anyone looking to
                  build a strong foundation in computer applications and digital
                  skills.
                </p>
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-blue-600 mb-2">
                      ...
                      <h3 className="font-semibold">4 Modules</h3>
                    </div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-blue-600 mb-2">
                      ...
                      <h3 className="font-semibold">50+ Hours</h3>
                    </div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-blue-600 mb-2">
                      ...
                      <h3 className="font-semibold">15+ Projects</h3>
                    </div>
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80"
            ...
            <div className="mb-16">
              ...
              <div className="grid-cols-2 grid gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "MS Excel - Data Analysis & Formulas",
                      "MS PowerPoint - Stunning Presentations",
                      "English & Hindi Typing Skills",
                    ].map((item, index) => (
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-orange-500 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                  <h4 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                    <Palette className="text-orange-500 mr-3" size={24} />
                    Design & Programming
                  </h4>
                  <ul className="space-y-3">
                    {[
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Complete practical projects and assessments to earn your
                    Certification in Computer Applications (CCA), validating
                    your expertise across all modules.
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Cover everything from basics to advanced topics in computer applications, design, and programming.",
                },
                {
                  icon: <Users size={40} className="text-orange-500" />,
                  title: "Expert Instructors",
                  description:
                    "Learn from industry professionals with years of practical experience in IT and design.",
                },
                {
                  icon: <Briefcase size={40} className="text-green-500" />,
                  title: "Career-Ready Skills",
                  description:
                    "Gain practical skills that are in high demand across industries for various job roles.",
                },
                {
                  icon: <BarChart2 size={40} className="text-purple-500" />,
                  title: "Hands-on Projects",
                  description:
                    "Apply your knowledge through 15+ practical projects based on real-world scenarios.",
                },
                {
                  icon: <Award size={40} className="text-yellow-500" />,
                  title: "Recognized Certificate",
                  description:
                    "Earn a CCA certificate that validates your expertise and enhances your professional profile.",
                },
                {
                  icon: <Zap size={40} className="text-red-500" />,
                  title: "Fast-Track Learning",
                  description:
                    "Complete the entire program in just 6 weeks with our intensive, focused curriculum.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Start Your Computer Applications Journey?
          </h2>
          <p className="text-xl mb-8 text-blue-100">
            Join thousands of students who have mastered essential computer
            skills with our comprehensive CCA program.
          </p>
          <button
            onClick={handleEnrollClick}
            disabled={isEnrolling}
...
export default CaaCourseDetail;
