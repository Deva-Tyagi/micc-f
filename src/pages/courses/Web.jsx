  ...
  const faqs = [
    {
      ...
      answer:
        "No prior coding experience is required. We start from the basics and gradually build your skills.",
    },
    {
      question: "What technologies will I learn?",
      answer:
        "You'll learn HTML, CSS, JavaScript, and modern web development frameworks to build complete websites.",
    },
    {
      question: "Will I build real websites?",
      answer:
        "Yes! You'll create multiple real-world projects including portfolios, business sites, and web applications.",
    },
    {
      question: "Is certification provided?",
      answer:
        "Yes, you'll receive a certificate upon completion validating your web development skills.",
    },
  ];
    ...
    <>
      <div className="relative h-[500px] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80')",
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-8 z-10">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <Globe size={40} className="text-orange-400 mr-3" />
              <h1 className="text-5xl font-extrabold">Web Development</h1>
            </div>
            <p className="text-xl text-center max-w-3xl mx-auto mt-4 text-gray-200">
              Build modern, responsive websites with HTML, CSS, JavaScript, and
              React
            </p>
          ...
          <div className="flex overflow-x-auto hide-scrollbar space-x-1 py-4">
            {["overview", "curriculum", "benefits", "faq"].map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full whitespace-nowrap transition-all duration-300 ${activeTab === tab ? "bg-indigo-600 text-white font-semibold" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
              >
          ...
          >
            <div className="grid grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  ...
                  Master HTML, CSS, JavaScript, and React to create professional
                  web applications.
                </p>
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1547658719-da2b51169166?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80"
                  alt="Web Development"
            ...
            <div className="mb-16">
              ...
              <div className="grid-cols-2 grid gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-indigo-500 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                  <h4 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                    <Code className="text-indigo-500 mr-3" size={24} />
                    Core Technologies
                  </h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Build and deploy a complete web application showcasing your
                    skills to earn your web development certificate.
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  title: "Modern Stack",
                  description:
                    "Learn the latest web technologies used by top companies worldwide.",
                },
                {
                  icon: <Globe size={40} className="text-orange-500" />,
                  title: "Real Projects",
                  description:
                    "Build portfolio-ready websites and applications from day one.",
                },
                {
                  icon: <Layout size={40} className="text-green-500" />,
                ...
                },
                {
                  ...
                  title: "Career Ready",
                  description:
                    "Gain skills in high demand for web developer and frontend engineer roles.",
                },
                {
                  icon: <Award size={40} className="text-yellow-500" />,
                  title: "Certification",
                  description:
                    "Earn a certificate proving your web development expertise.",
                },
                {
                  icon: <Zap size={40} className="text-red-500" />,
                  title: "Fast Track",
                  description:
                    "Go from beginner to building real websites in just 8 weeks.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
      ...
      <section className="py-16 bg-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <p className="text-xl mb-8 text-indigo-100">
            Join thousands of students who have launched their web development
            careers with our comprehensive program.
          </p>
          <button
            onClick={handleEnrollClick}
            disabled={isEnrolling}
            className="group relative px-8 py-4 bg-white text-indigo-600 font-bold rounded-lg shadow-lg hover:bg-indigo-50 transition-all duration-300"
          >
            {isEnrolling ? (
              <div className="flex items-center">
                <div className="animate-spin h-5 w-5 mr-3 border-t-2 border-indigo-600 rounded-full"></div>
                Processing...
              </div>
            ) : (
