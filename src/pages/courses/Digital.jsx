  ...
  const faqs = [
    {
      ...
      answer:
        "No prior marketing experience is required. We cover everything from basics to advanced digital marketing strategies.",
    },
    {
      question: "What platforms will I learn?",
      answer:
        "You'll learn SEO, social media marketing, Google Ads, email marketing, content marketing, and analytics.",
    },
    {
      question: "Will I run real campaigns?",
      answer:
        "Yes! You'll create and analyze real digital marketing campaigns as part of the course projects.",
    },
    {
      question: "Is certification provided?",
      answer:
        "Yes, you'll receive a certificate upon completion validating your digital marketing expertise.",
    },
  ];
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-8 z-10">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              <TrendingUp size={40} className="text-orange-400 mr-3" />
              <h1 className="text-5xl font-extrabold">Digital Marketing</h1>
            </div>
            <p className="text-xl text-center max-w-3xl mx-auto mt-4 text-gray-200">
              Master SEO, social media, paid ads, and analytics for online
              success
            </p>
          ...
          <div className="flex overflow-x-auto hide-scrollbar space-x-1 py-4">
            {["overview", "curriculum", "benefits", "faq"].map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full whitespace-nowrap transition-all duration-300 ${activeTab === tab ? "bg-orange-600 text-white font-semibold" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
              >
      ...
      <section className="py-16 px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="grid grid-cols-2 gap-12 items-center mb-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Master digital marketing with comprehensive training in SEO,
                  social media, paid advertising, and analytics. Learn to create
                  and optimize successful online campaigns.
                </p>
                <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <p className="text-gray-600 text-sm">Organic growth</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-orange-600 mb-2">
                    ...
                    <p className="text-gray-600 text-sm">Platform mastery</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-orange-600 mb-2">
                    ...
                    <p className="text-gray-600 text-sm">ROI optimization</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center text-orange-600 mb-2">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1533750349088-cd871a92f312?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80"
            ...
            <div className="mb-16">
              ...
              <div className="grid-cols-2 grid gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-red-500 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
                  <h4 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
          ...
          >
            ...
            <div className="mt-12 bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-lg border border-orange-100">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Create and present a complete digital marketing campaign
                    demonstrating your skills to earn your certificate.
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Master all aspects of digital marketing from SEO to paid advertising.",
                },
                {
                  icon: <Target size={40} className="text-red-500" />,
                  title: "Practical Skills",
                  description:
                    "Learn by creating real campaigns and analyzing actual results.",
                },
                {
                  icon: <Share2 size={40} className="text-blue-500" />,
                  title: "Platform Mastery",
                  description:
                    "Become proficient in Google Ads, Facebook Ads, and analytics tools.",
                },
                {
                  icon: <Users size={40} className="text-purple-500" />,
                  title: "Career Ready",
                  description:
                    "Gain skills for digital marketer, SEO specialist, and marketing manager roles.",
                },
                {
                  icon: <Award size={40} className="text-yellow-500" />,
                  title: "Certification",
                  description:
                    "Earn a certificate validating your digital marketing expertise.",
                },
                {
                  icon: <Zap size={40} className="text-green-500" />,
                  title: "High Demand",
                  description:
                    "Digital marketing skills are among the most sought-after in the job market.",
                },
              ].map((benefit, index) => (
                <div
                  key={index}
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <p className="text-xl mb-8 text-orange-100">
            Join thousands of marketers who have transformed their careers with
            our comprehensive digital marketing training.
          </p>
          <button
            onClick={handleEnrollClick}
            disabled={isEnrolling}
            className="group relative px-8 py-4 bg-white text-orange-600 font-bold rounded-lg shadow-lg hover:bg-orange-50 transition-all duration-300"
          >
            {isEnrolling ? (
              <div className="flex items-center">
                <div className="animate-spin h-5 w-5 mr-3 border-t-2 border-orange-600 rounded-full"></div>
                Processing...
              </div>
            ) : (
