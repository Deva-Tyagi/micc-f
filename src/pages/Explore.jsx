...
function ExploreCourses() {
    ...
    const courses = [
        ...
        },
        {
            ...
            description: "Get certified in CCC and O-Level courses by NIELET for foundational computer knowledge.",
            duration: "8 weeks",
            category: "Office",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        ...
                        <div className="w-full lg:w-3/5 z-10">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8">
                                <a href="#courses" className="group px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-700 font-semibold rounded-xl hover:bg-blue-50 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center">
                                    Explore Courses
                                    <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" />
                                </a>
                                <a href="#" className="px-6 sm:px-8 py-3 sm:py-4 bg-blue-600/30 backdrop-blur-sm border border-white/20 text-white font-semibold rounded-xl hover:bg-blue-600/40 transition duration-300 flex items-center justify-center">
                            ...
                            <div className="bg-white/10 backdrop-blur-lg p-4 sm:p-6 rounded-2xl shadow-2xl border border-white/20 transform hover:rotate-0 transition-transform duration-300">
                                <div className="relative h-40 sm:h-48 rounded-xl overflow-hidden mb-4">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-3 sm:p-4">
                                        <span className="text-white font-bold text-sm sm:text-base">Most Popular Course</span>
                                    </div>
                                </div>
                                <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Web Development Masterclass</h3>
                                <p className="text-blue-100 mb-4 text-xs sm:text-sm">Master modern web development with hands-on projects and real-world applications.</p>
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center">
                                        <Clock className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-blue-200" />
                                        <span className="text-blue-200 text-xs sm:text-sm">12 weeks</span>
                                    </div>
                                    <a href="#courses" className="text-white font-medium text-xs sm:text-sm hover:text-blue-200 transition-colors flex items-center">
                                        View Details
            ...
            {/* Course Section */}
            <section id="courses" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="mb-12 sm:mb-16 text-center">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-4">Our Professional Courses</h2>
                ...
                {filteredCourses.length === 0 && (
                    <div className="text-center py-12 sm:py-16">
                        <h3 className="text-xl sm:text-2xl font-medium text-gray-700 mb-4">No courses found</h3>
                        ...
                        {[
                            {
                                ...
                                answer: "You can enroll in any course by clicking on the 'View Course Details' button and following the enrollment instructions on the course page. Our enrollment process is simple and takes less than 2 minutes to complete.",
                                icon: <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />,
                            },
                            {
                                question: "Are certificates provided upon completion?",
                                answer: "Yes, we provide industry-recognized certificates for all courses upon successful completion of the course requirements and assessments. These certificates can be added to your LinkedIn profile and resume to showcase your skills.",
                                icon: <Award className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />,
                            },
                            {
                                question: "Can I access the course materials after completion?",
                                answer: "Yes, you will have lifetime access to all course materials after completion, allowing you to revisit the content whenever needed. This includes all videos, downloadable resources, and future updates to the course.",
                                icon: <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />,
                            },
                            {
                                question: "What if I'm not satisfied with the course?",
                                answer: "We offer a 30-day money-back guarantee for all our courses. If you're not satisfied with the course content or experience, you can request a full refund within 30 days of enrollment.",
                                icon: <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />,
                            },
                            {
                                question: "Do you offer any discounts for multiple courses?",
                                answer: "Yes, we offer bundle discounts when you enroll in multiple courses. You can save up to 30% when purchasing course bundles. Check our special offers page for current promotions.",
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center flex-1 min-w-0 mr-2">
                                        <div className="mr-3 sm:mr-4 p-2 bg-blue-50 rounded-full flex-shrink-0">{faq.icon}</div>
                                        <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800">{faq.question}</h3>
                                    </div>
                                    <div
                                ...
                                <div
                                    className={`px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out ${
                                        faqStates[index] ? "max-h-96 pb-4 sm:pb-6 opacity-100" : "max-h-0 opacity-0"
                                    }`}
                                >
