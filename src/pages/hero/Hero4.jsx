...
const ParallaxFeature = () => {
  ...
  const features = [
    {
      ...
      description:
        "Our AI-powered learning system adjusts to your pace, style, and progress to deliver a truly personalized experience. This ensures better understanding, higher retention, and smarter learning outcomes—every step of the way.",
      hinglish: "Jaise tum seekhte ho, waise hi system adapt hota hai.",
    ...
    },
    {
      ...
      description:
        "Fast-track your professional journey with high-demand skills designed for today’s competitive industries. Learn through real-world projects that build practical expertise, confidence, and long-term career growth.",
      hinglish:
        "Apne career ko do real speed — no shortcuts, only smart growth.",
    ...
    },
    {
      ...
      description:
        "Access expertly curated, high-quality content designed by industry leaders and updated in real time to match evolving trends. Built to deliver depth, relevance, and practical value—so you stay ahead, not just informed.",
      hinglish: "No fluff. Sirf high-signal, expert-level content.",
  ...
  const floatingIcons = [
    {
      ...
      x: "10%",
      y: "20%",
      size: "w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20",
      rotation: 15,
    ...
    },
    {
      ...
      x: "85%",
      y: "65%",
      size: "w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18 lg:w-24 lg:h-24",
      rotation: -10,
    ...
    },
    {
      ...
      x: "75%",
      y: "25%",
      size: "w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-16 lg:h-16",
      rotation: 5,
  ...
  return (
    ...
    >
          ...
          return (
            <motion.div
              ...
              animate={{
                ...
                rotate: [
                  item.rotation,
                  item.rotation + (item.rotation > 0 ? 25 : -25),
                ],
              }}
              transition={{
                repeat: Infinity,
      ...
      <motion.div
        className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-10"
        style={{ opacity }}
      >
        <motion.div
          className="text-center mb-12 sm:mb-14 md:mb-16 lg:mb-20 xl:mb-24"
        ...
        >
          ...
          <motion.p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base md:text-lg lg:text-xl px-4 sm:px-6 leading-relaxed">
            Stay ahead in a rapidly evolving digital landscape with cutting-edge
            courses designed to equip you with the most in-demand skills of
            tomorrow.
          </motion.p>
        </motion.div>
          ...
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                ...
                <motion.h3
                  className={`text-lg sm:text-xl md:text-2xl lg:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 ${feature.textColor}`}
                >
                  {feature.title}
                </motion.h3>
                <motion.p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed mb-2">
                  {feature.description}
                </motion.p>
                <motion.p className="text-gray-500 italic font-medium text-xs sm:text-sm md:text-base leading-relaxed opacity-90">
                  "{feature.hinglish}"
                </motion.p>
                <div className="mt-4 flex justify-end">
                  <div
                    className={`h-1 w-16 rounded-full bg-gradient-to-r ${feature.color.replace("bg-gradient-to-br", "")}`}
                  />
                </div>
        ...
        {/* <motion.div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-8 sm:mt-10 md:mt-12">
          {additionalFeatures.map((item, idx) => {
            ...
            return (
              ...
              >
                <motion.div
                  className={`w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-lg flex items-center justify-center mb-2 sm:mb-2.5 md:mb-3 bg-gradient-to-br ${item.color}`}
                >
