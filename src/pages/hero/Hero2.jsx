...
const FloatingIcons = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-10 sm:py-12 md:py-14 lg:py-16 bg-gradient-to-b from-gray-900 to-gray-800 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-2xl mx-auto px-4 leading-relaxed">
            Our curriculum covers the most in-demand skills and technologies in
            the industry
          </p>
        </motion.div>
...
const FeatureShowcase = () => {
  ...
  return (
    <section
      className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-gray-900 to-gray-800 text-white relative"
      ref={ref}
    >
      {/* Background overlays */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto px-4 leading-relaxed">
            We combine cutting-edge curriculum with expert instruction to
